...
func main() {
	...
	bh.Handle(func(bot *telego.Bot, update telego.Update) {
		...
		keyboard := tu.Keyboard(
			tu.KeyboardRow(
				tu.KeyboardButton("А"), // Added button "Горошок"
				tu.KeyboardButton("Б"), // Added button "Дауни"
			),
			tu.KeyboardRow(
				tu.KeyboardButton("В"), // Added button "Іди крадь"
				tu.KeyboardButton("Г"), // Added button "Гатила"
			),
			tu.KeyboardRow(
				tu.KeyboardButton("Д"), // Added button "Іди крадь"
				tu.KeyboardButton("Е"), // Added button "Гатила"
			),
			tu.KeyboardRow(
				tu.KeyboardButton("Є"), // Added button "Іди крадь"
				tu.KeyboardButton("Ж"), // Added button "Гатила"
			),
			tu.KeyboardRow(
				tu.KeyboardButton("З"), // Added button "Іди крадь"
				tu.KeyboardButton("І"), // Added button "Гатила"
			),
			tu.KeyboardRow(
	...
	bh.Handle(func(bot *telego.Bot, update telego.Update) {
		...
		switch text {
		case "А":
			sendVoice(bot, update, "voice/A.ogg", "А")
		case "Б":
			sendVoice(bot, update, "voice/B.ogg", "Б")
		case "В":
			sendVoice(bot, update, "voice/krad_.ogg", "В")
		case "А шо не так ?":
